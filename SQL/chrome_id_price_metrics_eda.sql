--INNER JOIN  ods.chrome__vin_c               AS v   ON h.vin = v.vin


/* Dev data is not up to date - need to ajust code */

select max(vin_last_dt)
from  dw.dealer_vin_price_sale_hist_c
;
--2017-12-03
...
drop table public_work_tbls.mp_base_90_v2;
